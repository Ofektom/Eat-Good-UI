...
import sideAlert from '/src/assets/vuesax-bulk-notification-mhd.png'
import sideAlertActive from '/src/assets/vuesax-bulk-notification-Xvs.png'
...
const Sidebar = ({handleComponentSelect, setIsLoggedOut}) => {
    ...
    <div className='sidebar-container'>
        ...
        <div className='side-upper'>
            ...
            <ul className='side-lower'>
                ...
                <li className={selected === 'track' ? 'side-lower-1-active' : 'side-lower-1'}  id='side-2' onClick={() => handleButtonClick('track')}>
                    <img className='side-home' src={selected === 'track' ? sideTrackActive : sideTrack} alt="track" />
                    <p className={selected === 'track' ? 'side-home-text-active' : 'side-home-text'}>Track</p>
                </li>
                ...
                <li className={selected === 'alert' ? 'side-lower-1-active' : 'side-lower-1'}  id='side-5' onClick={() => handleButtonClick('alert')}>
                    <img className='side-home' src={selected === 'alert' ? sideAlertActive : sideAlert} alt="alert" />
                    <p className={selected === 'alert' ? 'side-home-text-active' : 'side-home-text'}>Alert</p>
                </li>
